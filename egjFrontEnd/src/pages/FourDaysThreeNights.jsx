...
const highlights = [
  { icon: GiCanoe, title: "Four days in the Amazon", description: "Arrive in Gamboa by river, sleep in hammocks with mosquito nets, and explore farther reaches of the rainforest over multiple days." },
  { icon: GiCampCookingPot, title: "Deeper jungle knowledge", description: "Learn about medicinal plants, wildlife tracking, survival techniques, and the wider rainforest ecosystem through longer treks." },
  { icon: GiCrocJaws, title: "Caimans, lakes, and flooded forest", description: "Balance land and water exploration with birdwatching, canoeing, optional fishing, and supervised caiman encounters." },
  { icon: GiNightSleep, title: "Night walks and cultural moments", description: "Evening activities can include nocturnal wildlife walks, storytelling, or cultural interaction with the indigenous community." },
];

const itinerary = [
  { time: "DAY 1", title: "Arrival in Gamboa and first jungle encounter", description: "Travel about an hour along the Amazon River to Gamboa, settle into hammock accommodation, and begin a 2 to 3-hour trek among monkeys, birds, giant trees, spiders, and butterflies." },
  { time: "DAY 1", title: "Birdwatching, caimans, and night walk", description: "After lunch and rest, continue by canoe or boat to observe macaws, parrots, kingfishers, herons, toucans, and horned screamers, then experience caiman spotting and a nocturnal trek after dinner." },
  { time: "DAY 2", title: "Deeper rainforest trek", description: "Start with breakfast and continue on a 3 to 4-hour trek deeper into the jungle, focusing on medicinal plants, wildlife tracking, and survival techniques before lunch and rest." },
  { time: "DAY 2", title: "Flooded forest canoeing and evening options", description: "Spend the afternoon exploring lakes and flooded forest areas by canoe, with chances to spot birds and monkeys, optional fishing, dinner, and either a night walk or cultural exchange." },
  { time: "DAY 3", title: "Longer exploration day", description: "An extended day of trekking and river navigation takes you into more remote parts of the jungle, with stronger chances of wildlife sightings and more learning about plant uses and animal behavior." },
  { time: "DAY 3", title: "Flexible afternoon and night activity", description: "After lunch in the jungle or community, the afternoon may include canoeing, wildlife observation, or rest, followed by dinner and either a night walk or storytelling and cultural interaction." },
  { time: "DAY 4", title: "Final paddle and return to Leticia", description: "Wake early for breakfast, take a canoe ride through rivers and lakes in search of birds, monkeys, and possibly pink and gray dolphins, then return for lunch before heading back to Leticia by river." },
];
      ...
      <main className={page.page}>
        <motion.section className={page.hero} initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: "easeOut" }}>
          ...
          <p className={page.description}>
            A fuller Amazon immersion with longer jungle exploration, river navigation into remote areas, wildlife-focused canoe routes, and flexible evenings shaped by the forest, the season, and the community around you.
          </p>
        ...
        <motion.section id="itinerary" className={page.section} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-10%" }} transition={{ duration: 0.6, ease: "easeOut" }}>
          ...
          <p className={page.note}>
            <span>A note on flexibility</span> — activities may vary depending on weather, season, and guide decisions. The itinerary stays flexible to minimize environmental impact. Dry season (Jan-Mar, Jul-Sep) usually allows longer hikes, while rainy season (Apr-Jun, Oct-Dec) favors more water-based activities.
          </p>
        </motion.section>
